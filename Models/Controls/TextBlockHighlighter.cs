...
namespace Ark.Models.Controls
{
    public static class TextBlockHighlighter
    {
        ...
        public static bool GetIgnoreDot(DependencyObject obj)
        {
            return (bool)obj.GetValue(IgnoreDotProperty);
        }

        public static void SetIgnoreDot(DependencyObject obj, bool value)
        {
            obj.SetValue(IgnoreDotProperty, value);
        }

        public static readonly DependencyProperty IgnoreDotProperty =
            DependencyProperty.RegisterAttached("IgnoreDot", typeof(bool), typeof(TextBlockHighlighter),
                new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender,
                new PropertyChangedCallback(SelectText)));
        private static void SelectText(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            bool IgnoreDot = (bool)d.GetValue(IgnoreDotProperty);
